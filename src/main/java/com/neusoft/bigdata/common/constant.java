...
public class constant {
	...
	private static BasicCookieStore getCookieStore(){
		...
		for (int i = 0; i < arr.length; i++) {
			...
			store.addCookie(new BasicClientCookie(cookie[0], cookie[1]));
		}
		return store;
	}
