...
public class AnjukeCrawlerService implements ICrawlerService {
	...
	private static String referer="https://fs.fang.anjuke.com/";
	private static String acceptEncoding="gzip, deflate, br";
	private  WebCralwer<NewHouse> cralwer;
	
	public AnjukeCrawlerService(){
		cralwer=new WebCralwer<NewHouse>();
	}
	...
	public  void CatData(String... url) {
		...
		cralwer.setSleepTime(3000);
		cralwer.setRequestHeader(acceptEncoding, cookie, null, referer);
		cralwer.addRoot(url);
		cralwer.start(2);
	}
